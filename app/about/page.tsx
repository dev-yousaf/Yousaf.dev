            ...
            >
              <div className="aspect-square rounded-2xl overflow-hidden bg-linear-to-br from-blue-100 to-purple-100 dark:from-gray-800 dark:to-gray-700 relative">
                ...
                <Image
                  ...
                  priority
                />
                <div className="absolute inset-0 bg-linear-to-t from-white/50 to-transparent dark:from-gray-900/50" />
              </div>
      ...
      <section className="py-20 px-4 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Technical Arsenal</h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
      ...
      <section className="py-20 px-4 bg-white dark:bg-gray-900">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Life & Work</h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
